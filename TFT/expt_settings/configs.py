...
import data_formatters.visitors
...
class ExperimentConfig(object):
  ...
  default_experiments = ['volatility', 'electricity', 'traffic', 'favorita', 'visitors']
  ...
  def make_data_formatter(self):
    ...
    data_formatter_class = {
        ...
        'visitors': data_formatters.visitors.VisitorsFormatter
    }
